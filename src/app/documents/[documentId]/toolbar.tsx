        ...
        {lineHeights.map(({ label, value }) => (
          <button
            ...
            className={cn("flex items-center gap-x-2 px-2 py-1 rounded-sm hover:bg-neutral-200/80",
              editor?.getAttributes("paragraph").lineHeights === value && 'bg-slate-200/80'
            )}
          >
    ...
    <div className='flex items-center gap-x-0.5'>
      ...
      {isEditing ? (
        <input
          ...
          className='h-7 w-10 text-sm flex items-center justify-center border border-neutral-400 text-center rounded-sm bg-transparent focus:outline-none focus:ring-0'
        />
      ) : (
        <button
          onClick={() => {
          ...
          className='h-7 w-10 text-sm flex items-center justify-center border border-neutral-400 text-center rounded-sm bg-transparent cursor-text'
        >
          {currentFontSize}
        </button>
      )}
